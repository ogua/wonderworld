    ...
    <div class="container-xxl bg-white p-0">
            ...
            <div class="container py-5">
                ...
                <nav aria-label="breadcrumb animated slideInDown">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item text-white active" aria-current="page">Carrier Day</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <div class="container py-md-5 py-4">
            <div class="title-main text-center mx-auto mb-md-5 mb-4" style="max-width:500px;">
                ...
                <h3 class="title-style">Carrier Day</h3>
            </div>
            
                <div id="nanoGallery3">
                <?php
                    $sql = "SELECT * FROM imageuploads WHERE uniqueid = '".$uniqueid."' and cat = '1' ";
